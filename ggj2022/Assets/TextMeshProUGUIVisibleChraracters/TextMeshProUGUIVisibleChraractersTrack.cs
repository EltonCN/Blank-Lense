...
[TrackClipType(typeof(TextMeshProUGUIVisibleChraractersClip))]
[TrackBindingType(typeof(TextMeshProUGUI))]
public class TextMeshProUGUIVisibleChraractersTrack : TrackAsset
{
    public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
    {
        return ScriptPlayable<TextMeshProUGUIVisibleChraractersMixerBehaviour>.Create (graph, inputCount);
    }
