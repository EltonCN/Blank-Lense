...
[TrackClipType(typeof(TextMeshProUGUI_VertexColorClip))]
[TrackBindingType(typeof(TextMeshProUGUI))]
public class TextMeshProUGUI_VertexColorTrack : TrackAsset
{
    public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
    {
        return ScriptPlayable<TextMeshProUGUI_VertexColorMixerBehaviour>.Create (graph, inputCount);
    }
