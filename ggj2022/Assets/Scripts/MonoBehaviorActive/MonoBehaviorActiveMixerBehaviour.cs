...
public class MonoBehaviorActiveMixerBehaviour : PlayableBehaviour
{
    ...
    public override void ProcessFrame(Playable playable, FrameData info, object playerData)
    {
        ...
        for (int i = 0; i < inputCount; i++)
        {
            ...
            ScriptPlayable<MonoBehaviorActiveBehaviour> inputPlayable = (ScriptPlayable<MonoBehaviorActiveBehaviour>)playable.GetInput(i);
            MonoBehaviorActiveBehaviour input = inputPlayable.GetBehaviour ();
