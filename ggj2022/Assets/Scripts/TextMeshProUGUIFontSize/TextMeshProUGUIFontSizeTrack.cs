...
[TrackClipType(typeof(TextMeshProUGUIFontSizeClip))]
[TrackBindingType(typeof(TextMeshProUGUI))]
public class TextMeshProUGUIFontSizeTrack : TrackAsset
{
    public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
    {
        return ScriptPlayable<TextMeshProUGUIFontSizeMixerBehaviour>.Create (graph, inputCount);
    }
    ...
    public override void GatherProperties (PlayableDirector director, IPropertyCollector driver)
    {
        ...
        driver.AddFromName<TextMeshProUGUI>(trackBinding.gameObject, "m_fontSize");
#endif
